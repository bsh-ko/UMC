          ...
          <>
            <input
              ...
              className={`border w-[300px] p-[10px] focus:outline-pink-500 rounded-sm focus:outline-2 placeholder-gray-200 text-white ${
                errors.email ? "border-red-500 bg-red-200 text-black" : "border-gray-200"
              }`}
              placeholder="이메일"
            />
          ...
          <>
            ...
            <div className="relative w-[300px]">
              <input
                ...
                className={`border w-full p-[10px] pr-10 focus:outline-pink-500 rounded-sm focus:outline-2 placeholder-gray-200 text-white ${
                  errors.password ? "border-red-500 bg-red-200 text-black" : "border-gray-200"
                }`}
                placeholder="비밀번호"
              />
              <button
                ...
                className="absolute top-1/2 right-2 transform -translate-y-1/2 w-5 h-5 bg-white rounded-xl"
              >
                {showPassword ? <img src="/eye-open.png" /> : <img src="/eye-close.png" alt="숨기기" />}
              </button>
            </div>
            ...
            <div className="relative w-[300px]">
              <input
                ...
                className={`border w-full p-[10px] pr-10 focus:outline-pink-500 rounded-sm focus:outline-2 placeholder-gray-200 text-white ${
                  errors.passwordCheck ? "border-red-500 bg-red-200 text-black" : "border-gray-200"
                }`}
                placeholder="비밀번호 확인"
              />
              <button
                ...
                className="absolute top-1/2 right-2 transform -translate-y-1/2 w-5 h-5 bg-white rounded-xl"
              >
                {showPasswordCheck ? <img src="/eye-open.png" /> : <img src="/eye-close.png" />}
              </button>
            </div>
        ...
        {step === 3 && (
          <>
            <input
              ...
              type="text"
              className={`border w-[300px] p-[10px] focus:outline-pink-500 rounded-sm focus:outline-2 placeholder-gray-200 text-white ${
                errors.name ? "border-red-500 bg-red-200 text-black" : "border-gray-200"
              }`}
              placeholder="이름"
            />
